...
// d3.json('../data/intervals@3.json', d3.autoType).then(function (intervals) {
//     let names = intervals.map(d => d.name);
//     let hierarchicalData = d3.stratify()(intervals)
//         .sum(d => (d.leaf ? d.start - d.end : 0))
//         .sort((a, b) => b.start - a.start);
//     let root = partition(hierarchicalData);
//     let focus = root;
//
//     let cellGroup = tree_g.append('g')
//         .attr('id', 'cells');
//
//     const cell = cellGroup.selectAll('g')
//         .data(root.descendants())
...
//
//         rect.attr("cursor", "grabbing");
//         tree_g.attr("transform", `translate(${translateX},0)`);
//     }
// })
